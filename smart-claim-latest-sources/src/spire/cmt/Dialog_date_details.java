...
public class Dialog_date_details extends DialogFragment implements
		OnClickListener {
	...
	public void add_list() {
		...
		month = dpResult.getMonth() + 1;
		day = dpResult.getDayOfMonth();
		ood.names_info[ood.pos + i] = String.valueOf(year) + " "
				+ String.valueOf(month) + " " + String.valueOf(day);
		ood.names_title[ood.pos + i] = ood.names[ood.pos + i]
