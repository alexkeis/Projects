...
public class Dialog_date_lodge_claim_details extends DialogFragment implements OnClickListener {
  ...
  Lodge_claim_your_details ood = new Lodge_claim_your_details();
 ...
 public String pol;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
	  ...
	  dialog_n = new Dialog_details_lodge_claim();
  ...
  public void add_list()
  {
	  ...
	  month=dpResult.getMonth()+1;
	  day=dpResult.getDayOfMonth();	 
  	ood.names_info[ood.pos + i]=String.valueOf(year)+ " " +String.valueOf(month)+ " " +String.valueOf(day);
  	ood.names_title[ood.pos + i]=ood.names[ood.pos + i] + ood.names_info[ood.pos + i];	
  }
