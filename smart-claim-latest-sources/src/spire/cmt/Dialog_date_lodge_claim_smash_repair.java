...
public class Dialog_date_lodge_claim_smash_repair extends DialogFragment implements OnClickListener {
  ...
  Lodge_claim_smash_repair ood = new Lodge_claim_smash_repair();
 ...
 public String pol;
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
	  ...
	  dialog_n = new Dialog_vehicle_smash_repair();
	  pol=ood.names[3];
  ...
  public void add_list()
  {
	  ...
	  month=dpResult.getMonth()+1;
	  day=dpResult.getDayOfMonth();	 
  	ood.names_info[ood.pos2 + i]=String.valueOf(year)+ " " +String.valueOf(month)+ " " +String.valueOf(day);
  	ood.names_title[ood.pos2 + i]=ood.names[ood.pos2 + i] + ood.names_info[ood.pos2 + i];	
  }
  public void onClick(View v) {
	...
	case R.id.btnYes_date:
		...
		case R.id.btnNo_date:
		{
			  ...
			  month=dpResult.getMonth()+1;
			  day=dpResult.getDayOfMonth();	 
			  	ood.names_info[3]=String.valueOf(year)+ " " +String.valueOf(month)+ " " +String.valueOf(day);
			  	ood.names_title[3]=ood.names[3] + ood.names_info[3];		
			rez=0;
			dismiss();
