...
public class Other_drivers_vechickes extends Activity {
  ...
  void readFile_info() {
	  String str = "";
	    ...
	    String vr_str="";	    
		File path=new File(getFilesDir(),"/CMT/"+lg.nameFolder);
	  	File sdFile=new File(path,mas_name_file[pos_mas_name].replace(" ","")+".txt");
  ...
  public void list()
  {
	    ...
	    ArrayAdapter<String> adapt = new ArrayAdapter<String>(this,	R.layout.list_item, mas_name_file);
