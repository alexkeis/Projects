...
public class Dialog1 extends DialogFragment implements OnClickListener {
	...
	public void date() {
		...
		txt.setText(year + "." + month + "." + day + " " + hoursString + ":"
				+ minutesString);
		...
		try {
			...
			bw.write(year + "." + month + "." + day + " " + hoursString + ":"
					+ minutesString);
	...
	public void onDismiss(DialogInterface dialog) {
		...
		// R.layout.lodge_claim, null);
		// view.requestLayout();
		// listView = (ListView)view.findViewById(R.id.listView_lodge_claim);
		//
