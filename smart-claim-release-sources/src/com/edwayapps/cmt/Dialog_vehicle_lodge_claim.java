...
public class Dialog_vehicle_lodge_claim extends DialogFragment implements OnClickListener {
	
	EditText edit_driver;
	Button yyy;
	String sd;
	Lodge_claim_your_vehicle yd = new Lodge_claim_your_vehicle();
	DialogFragment ds;
...
public void add_list()
{
  ...
  public void onDismiss(DialogInterface dialog) {
	  if(click==0)
	  {
		    ...
		    intent1.setClass(getActivity(), Lodge_claim_your_vehicle.class);
