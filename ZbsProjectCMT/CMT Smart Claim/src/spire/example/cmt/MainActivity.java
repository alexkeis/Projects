...
//		lParams1 =(RelativeLayout.LayoutParams) imageView_header1.getLayoutParams();
//		lParams1.height = (metrics.heightPixels*16)/100;
//		lParams1 =(RelativeLayout.LayoutParams) imageView_banner.getLayoutParams();
...
//		lParams4.height=(((metrics.heightPixels*91)/100)-((metrics.heightPixels*16)/100)-((metrics.heightPixels*11)/100)-((metrics.heightPixels*4)/100));
	...
	protected Dialog onCreateDialog(int id) {
		...
		switch (id) {		
		case IDD_BUTTONS:{
			builder.setMessage("Would you like to call CMT \n Dial 1300 663 470?")
					.setCancelable(false)
		...
		case 1:
		{
			final String[] list ={"Yes", "No", "Cancel"};

			builder = new AlertDialog.Builder(this);
			builder.setTitle("Do you have an existing client ID");
