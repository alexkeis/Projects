...
public class Lodge_claim_your_vehicle extends Activity{
	DialogFragment dialog2;
	 ...
	 int pp2;
	  ...
	  public static String[] names_title = {
		  "Make " + names_info[0],"Model "+ names_info[1],"Rego "+ names_info[2]};  
	...
	public void onCreate(Bundle savedInstanceState) {
	  ...
	  public void list()
	  {
		    ...
		    View header = getLayoutInflater().inflate(R.layout.header_vehicle, null);
	  ...
	  public void button_use_my_proile_vehicle(View view)
	  {
		  ...
		  finish();
		    ...
		    intent1.setClass(getApplicationContext(), Lodge_claim_your_vehicle.class);
